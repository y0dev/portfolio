        ...
        <div className="max-w-4xl mx-auto">
          ...
          <header className="mb-12">
            <div className="flex items-center gap-4 mb-6">
              {/* Article Image */}
              {article.image && (
                <div className="relative w-16 h-16 rounded-xl overflow-hidden shadow-lg border-2 border-gray-200 dark:border-gray-700 flex-shrink-0 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-700">
                  <Image
