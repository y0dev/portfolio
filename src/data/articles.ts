...
export const articles: Article[] = [
  {
    "id": "petalinux-gotchas-with-xsa-templates-and-pl-programming",
    "title": "PetaLinux Gotchas with XSA Templates and PL Programming",
    "description": "Notes on common PetaLinux pitfalls when using XSA-based templates, including DTG configuration and PL programming requirements.",
    ...
    "content": [
      { "title": "Topic: PetaLinux Project Setup and Boot Issues", "htmlContent": "<div class=\"space-y-2 mb-4\"><p class=\"text-gray-700 dark:text-gray-300 leading-relaxed mb-2\"><strong class=\"font-bold text-gray-900 dark:text-white\">Date:</strong> 12/19/2025\n</p><p class=\"text-gray-700 dark:text-gray-300 leading-relaxed mb-2\"><strong class=\"font-bold text-gray-900 dark:text-white\">Source:</strong> Hands-on debugging / personal notes</p></div>\n<hr class=\"border-gray-300 dark:border-gray-600 my-8\">\n<h4 class=\"text-2xl font-bold text-gray-900 dark:text-white mb-4 mt-6\">Key Points</h4>\n<ul class=\"mb-4 space-y-2 list-disc list-outside ml-6\">\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">Creating a PetaLinux project from a template does <strong class=\"font-bold text-gray-900 dark:text-white\">not</strong> fully auto-detect the board from the XSA</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">Device Tree Generator (DTG) must be explicitly configured</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">Linux kernel may fail to boot if the Programmable Logic (PL) is not programmed</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">These issues can appear as early boot hangs or RCU stalls</li>\n</ul>\n<h4 class=\"text-2xl font-bold text-gray-900 dark:text-white mb-4 mt-6\">Examples &amp; Details</h4>\n<p style=\"display: block;\" class=\"text-gray-700 dark:text-gray-300 leading-relaxed mb-4\"><strong class=\"font-bold text-gray-900 dark:text-white\">References:</strong></p>\n<ul class=\"mb-4 space-y-2 list-disc list-outside ml-6\">\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\"><p style=\"display: block;\" class=\"text-gray-700 dark:text-gray-300 leading-relaxed mb-2\">PetaLinux Tools Reference Guide: <a href=\"https://docs.amd.com/r/en-US/ug1144-petalinux-tools-reference-guide\" class=\"text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 underline hover:no-underline transition-colors duration-200\">https://docs.amd.com/r/en-US/ug1144-petalinux-tools-reference-guide</a></p>\n</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\"><p style=\"display: block;\" class=\"text-gray-700 dark:text-gray-300 leading-relaxed mb-2\">DTG Configuration Settings: <a href=\"https://docs.amd.com/r/en-US/ug1144-petalinux-tools-reference-guide/DTG-Settings\" class=\"text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 underline hover:no-underline transition-colors duration-200\">https://docs.amd.com/r/en-US/ug1144-petalinux-tools-reference-guide/DTG-Settings</a></p>\n</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\"><p style=\"display: block;\" class=\"text-gray-700 dark:text-gray-300 leading-relaxed mb-2\">When importing an <code class=\"bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 px-2 py-1 rounded text-sm font-mono\">.xsa</code> into a PetaLinux project, DTG is <strong class=\"font-bold text-gray-900 dark:text-white\">not</strong> automatically set to infer configuration from hardware</p>\n</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\"><p style=\"display: block;\" class=\"text-gray-700 dark:text-gray-300 leading-relaxed mb-2\">DTG must be manually set to <code class=\"bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 px-2 py-1 rounded text-sm font-mono\">AUTO</code>:</p>\n</li>\n</ul>\n<pre><code class=\"language-text\">petalinux-config\n  → DTG Settings\n    → (DTG_AUTOCONFIG) AUTO\n</code></pre>\n<ul class=\"mb-4 space-y-2 list-disc list-outside ml-6\">\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">In another case, the Linux kernel would not boot because PL-based peripherals were expected</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">The kernel stalled because the PL bitstream was never loaded</li>\n</ul>\n<h4 class=\"text-2xl font-bold text-gray-900 dark:text-white mb-4 mt-6\">Questions &amp; Clarifications</h4>\n<ul class=\"mb-4 space-y-2 list-disc list-outside ml-6\">\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">Is DTG behavior consistent across PetaLinux versions?</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">Which boot stage is best for PL programming in this setup (FSBL vs U-Boot)?</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">Can missing PL programming always be detected via boot logs?</li>\n</ul>\n<h4 class=\"text-2xl font-bold text-gray-900 dark:text-white mb-4 mt-6\">Action Items / Next Steps</h4>\n<ul class=\"mb-4 space-y-2 list-disc list-outside ml-6\">\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\"><p style=\"display: block;\" class=\"text-gray-700 dark:text-gray-300 leading-relaxed mb-2\">Review AMD documentation for DTG behavior and defaults</p>\n<ul class=\"mb-2 space-y-1 list-disc list-outside ml-6\">\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">PetaLinux Tools Reference Guide: <a href=\"https://docs.amd.com/r/en-US/ug1144-petalinux-tools-reference-guide\" class=\"text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 underline hover:no-underline transition-colors duration-200\">https://docs.amd.com/r/en-US/ug1144-petalinux-tools-reference-guide</a></li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">DTG Settings Reference: <a href=\"https://docs.amd.com/r/en-US/ug1144-petalinux-tools-reference-guide/DTG-Settings\" class=\"text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 underline hover:no-underline transition-colors duration-200\">https://docs.amd.com/r/en-US/ug1144-petalinux-tools-reference-guide/DTG-Settings</a></li>\n</ul>\n</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\"><p style=\"display: block;\" class=\"text-gray-700 dark:text-gray-300 leading-relaxed mb-2\">Always verify DTG settings after importing an XSA</p>\n</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\"><p style=\"display: block;\" class=\"text-gray-700 dark:text-gray-300 leading-relaxed mb-2\">Confirm PL programming is included in the boot flow</p>\n</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\"><p style=\"display: block;\" class=\"text-gray-700 dark:text-gray-300 leading-relaxed mb-2\">Add a pre-boot checklist for PetaLinux projects</p>\n</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\"><p style=\"display: block;\" class=\"text-gray-700 dark:text-gray-300 leading-relaxed mb-2\">Document boot dependencies between PS and PL peripherals</p>\n</li>\n</ul>\n<h4 class=\"text-2xl font-bold text-gray-900 dark:text-white mb-4 mt-6\">Summary</h4>\n<p style=\"display: block;\" class=\"text-gray-700 dark:text-gray-300 leading-relaxed mb-4\">PetaLinux templates simplify project creation but do not eliminate the need for explicit configuration. DTG must be set to <code class=\"bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 px-2 py-1 rounded text-sm font-mono\">AUTO</code> to properly generate the device tree from an XSA, and Linux will not boot correctly if it depends on PL-based hardware that has not been programmed. Making these steps explicit early prevents long debugging sessions.</p>\n<hr class=\"border-gray-300 dark:border-gray-600 my-8\">\n" }
    ]
  },
  {
    "id": "running-nist-sts-212",
    "title": "Running NIST STS 2.1.2",
    "description": "Step-by-step guide for installing, configuring, and using the NIST Statistical Test Suite (STS) 2.1.2 to assess randomness of bitstreams, especially in Cygwin, WSL, and Linux environments.",
    "date": "June 10, 2025",
    ...
    "content": [
      { "title": "Topic: NIST STS 2.1.2", "htmlContent": "<div class=\"space-y-2 mb-4\"><p class=\"text-gray-700 dark:text-gray-300 leading-relaxed mb-2\"><strong class=\"font-bold text-gray-900 dark:text-white\">Date:</strong> [MM/DD/YYYY]\n</p><p class=\"text-gray-700 dark:text-gray-300 leading-relaxed mb-2\"><strong class=\"font-bold text-gray-900 dark:text-white\">Source:</strong> [NIST SP800-22, Software Documentation, Personal Testing]</p></div>\n<hr class=\"border-gray-300 dark:border-gray-600 my-8\">\n<h4 class=\"text-2xl font-bold text-gray-900 dark:text-white mb-4 mt-6\">Key Points</h4>\n<ul class=\"mb-4 space-y-2 list-disc list-outside ml-6\">\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">NIST STS is used to assess the randomness of binary sequences.</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">Includes multiple tests defined in the NIST SP800-22 publication.</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">Requires a properly formatted bitstream as input.</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">Must be built using <code class=\"bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 px-2 py-1 rounded text-sm font-mono\">make</code> and <code class=\"bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 px-2 py-1 rounded text-sm font-mono\">gcc</code> on a Unix-like system.</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">Test results are stored in the <code class=\"bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 px-2 py-1 rounded text-sm font-mono\">experiments/</code> directory.</li>\n</ul>\n<hr class=\"border-gray-300 dark:border-gray-600 my-8\">\n<h4 class=\"text-2xl font-bold text-gray-900 dark:text-white mb-4 mt-6\">Examples &amp; Details</h4>\n<h5 class=\"text-2xl font-bold text-gray-900 dark:text-white mb-4 mt-6\">✅ Prerequisites</h5>\n<ul class=\"mb-4 space-y-2 list-disc list-outside ml-6\">\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\"><p style=\"display: block;\" class=\"text-gray-700 dark:text-gray-300 leading-relaxed mb-2\">Linux/macOS/WSL/Cygwin with:</p>\n<ul class=\"mb-2 space-y-1 list-disc list-outside ml-6\">\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\"><code class=\"bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 px-2 py-1 rounded text-sm font-mono\">make</code></li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\"><code class=\"bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 px-2 py-1 rounded text-sm font-mono\">gcc</code></li>\n</ul>\n</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\"><p style=\"display: block;\" class=\"text-gray-700 dark:text-gray-300 leading-relaxed mb-2\">Terminal and file access</p>\n</li>\n</ul>\n<h5 class=\"text-2xl font-bold text-gray-900 dark:text-white mb-4 mt-6\">📦 Download and Extract</h5>\n<pre><code class=\"language-bash\">unzip sts-2.1.2.zip\ncd sts-2.1.2\n</code></pre>\n<h5 class=\"text-2xl font-bold text-gray-900 dark:text-white mb-4 mt-6\">🛠️ Build the Suite</h5>\n<pre><code class=\"language-bash\">make\n</code></pre>\n<h5 class=\"text-2xl font-bold text-gray-900 dark:text-white mb-4 mt-6\">🧪 Input File Format</h5>\n<ul class=\"mb-4 space-y-2 list-disc list-outside ml-6\">\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\"><p style=\"display: block;\" class=\"text-gray-700 dark:text-gray-300 leading-relaxed mb-2\">Pure 0s and 1s, no headers, no whitespace.</p>\n</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\"><p style=\"display: block;\" class=\"text-gray-700 dark:text-gray-300 leading-relaxed mb-2\">Example:</p>\n<pre><code class=\"language-text\">01010011010101...\n</code></pre>\n</li>\n</ul>\n<h5 class=\"text-2xl font-bold text-gray-900 dark:text-white mb-4 mt-6\">🏁 Run the Suite</h5>\n<pre><code class=\"language-bash\">./assess 1000000\n</code></pre>\n<p style=\"display: block;\" class=\"text-gray-700 dark:text-gray-300 leading-relaxed mb-4\">Interactive options:</p>\n<ol class=\"mb-4 space-y-2 list-decimal list-outside ml-6\">\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">Input file</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">Select tests</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">Run tests</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">View results</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">Exit</li>\n</ol>\n<p style=\"display: block;\" class=\"text-gray-700 dark:text-gray-300 leading-relaxed mb-4\">Follow steps: <code class=\"bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 px-2 py-1 rounded text-sm font-mono\">0 → 1 → 2 → 3 → 0</code></p>\n<h5 class=\"text-2xl font-bold text-gray-900 dark:text-white mb-4 mt-6\">📁 Output</h5>\n<p style=\"display: block;\" class=\"text-gray-700 dark:text-gray-300 leading-relaxed mb-4\">Stored in:</p>\n<pre><code class=\"language-bash\">experiments/AlgorithmTesting/\n├── data.epsilon\n├── results.txt\n├── stats.txt\n</code></pre>\n<p style=\"display: block;\" class=\"text-gray-700 dark:text-gray-300 leading-relaxed mb-4\">Each test result includes logs and summaries.</p>\n<h5 class=\"text-2xl font-bold text-gray-900 dark:text-white mb-4 mt-6\">🧪 Common Test Numbers</h5>\n<div class=\"overflow-x-auto my-6\"><table class=\"min-w-full divide-y divide-gray-200 dark:divide-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg overflow-hidden shadow-sm\">\n<thead class=\"bg-gray-50 dark:bg-gray-800\">\n<tr>\n<th class=\"px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider border-b border-gray-200 dark:border-gray-700\">Test #</th>\n<th class=\"px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider border-b border-gray-200 dark:border-gray-700\">Name</th>\n</tr>\n</thead>\n<tbody class=\"bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700\"><tr class=\"bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors\">\n<td class=\"px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 text-left border-b border-gray-200 dark:border-gray-700\">1</td>\n<td class=\"px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 text-left border-b border-gray-200 dark:border-gray-700\">Frequency (Monobit)</td>\n</tr>\n<tr class=\"bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors\">\n<td class=\"px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 text-left border-b border-gray-200 dark:border-gray-700\">2</td>\n<td class=\"px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 text-left border-b border-gray-200 dark:border-gray-700\">Block Frequency</td>\n</tr>\n<tr class=\"bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors\">\n<td class=\"px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 text-left border-b border-gray-200 dark:border-gray-700\">3</td>\n<td class=\"px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 text-left border-b border-gray-200 dark:border-gray-700\">Runs</td>\n</tr>\n<tr class=\"bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors\">\n<td class=\"px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 text-left border-b border-gray-200 dark:border-gray-700\">4</td>\n<td class=\"px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 text-left border-b border-gray-200 dark:border-gray-700\">Longest Run of Ones</td>\n</tr>\n<tr class=\"bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors\">\n<td class=\"px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 text-left border-b border-gray-200 dark:border-gray-700\">5</td>\n<td class=\"px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 text-left border-b border-gray-200 dark:border-gray-700\">Rank</td>\n</tr>\n<tr class=\"bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors\">\n<td class=\"px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 text-left border-b border-gray-200 dark:border-gray-700\">6</td>\n<td class=\"px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 text-left border-b border-gray-200 dark:border-gray-700\">Discrete Fourier Transform</td>\n</tr>\n<tr class=\"bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors\">\n<td class=\"px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 text-left border-b border-gray-200 dark:border-gray-700\">7</td>\n<td class=\"px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 text-left border-b border-gray-200 dark:border-gray-700\">Non-overlapping Template</td>\n</tr>\n</tbody></table></div>\n<hr class=\"border-gray-300 dark:border-gray-600 my-8\">\n<h4 class=\"text-2xl font-bold text-gray-900 dark:text-white mb-4 mt-6\">Questions &amp; Clarifications</h4>\n<ul class=\"mb-4 space-y-2 list-disc list-outside ml-6\">\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">How are thresholds for p-values determined across different tests?</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">What is the statistical basis for deciding pass/fail?</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">Can custom test suites be integrated?</li>\n</ul>\n<hr class=\"border-gray-300 dark:border-gray-600 my-8\">\n<h4 class=\"text-2xl font-bold text-gray-900 dark:text-white mb-4 mt-6\">Action Items / Next Steps</h4>\n<ul class=\"mb-4 space-y-2 list-disc list-outside ml-6\">\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">Automate test run with <code class=\"bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 px-2 py-1 rounded text-sm font-mono\">subprocess</code>/Python</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">Generate visual summaries of p-value distributions</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">Compare test results across multiple RNG implementations</li>\n<li class=\"mb-2 text-gray-700 dark:text-gray-300 transition-colors duration-200\">Read SP800-22 full documentation</li>\n</ul>\n<hr class=\"border-gray-300 dark:border-gray-600 my-8\">\n<h4 class=\"text-2xl font-bold text-gray-900 dark:text-white mb-4 mt-6\">Summary</h4>\n<p style=\"display: block;\" class=\"text-gray-700 dark:text-gray-300 leading-relaxed mb-4\">NIST STS 2.1.2 is a powerful suite for validating the statistical randomness of bitstreams. After compiling the suite, a clean binary file of known length can be tested via an interactive CLI. Results are saved for inspection. Automation is possible using scripting, and understanding individual test behavior is key for interpreting results.</p>\n" }
    ]
  },
  {
