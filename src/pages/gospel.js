...
import './css/gospel.css';

class GospelPage extends React.Component {
    render() {
        return (
            <div className="gospel-page">
                {/* Hero Section */}
                <section className="gospel-hero">
                    <div className="gospel-hero-container">
                        <div className="gospel-hero-content">
                            <h1 className="gospel-hero-title">✝️ The Gospel of Jesus Christ</h1>
                            <p className="gospel-hero-subtitle">
                                The good news that transforms lives and offers eternal hope
                            </p>
                            <div className="gospel-hero-verse">
                                <blockquote>
                ...
                {/* Main Content */}
                <section className="gospel-content">
                    <div className="gospel-container">
                        <div className="gospel-text-content">
                            <p>
                        ...
                        {/* Call to Action */}
                        <div className="gospel-cta">
                            <div className="cta-content">
                                <h2 className="cta-title">The Choice is Yours</h2>
